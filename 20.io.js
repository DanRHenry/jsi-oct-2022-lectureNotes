...
!   Input/Output I/O
    ...
    - A computer's response is the output.
        - printing, sounds, etc.
    - CPU and RAM process these actions
        - ALL other parts of a computer would be considered the i/o
        - keyboard, mouse, monitor, headphones, etc.
*/

//* Standard In / Standard Out
// Working within i/o in the terminal.
...
/* 
    ...
    2. We have access to a property within our process.
    3. A method within the property. Requires two parameters, type to listen for, and a callback function. (this is an event listener, when it gets the input, it runs the function)
...
// process.stdin.once("data", callbackFunc); // creating a function called callbackFunc // commented out so we can run later code
// process.stdin.once("data", callbackFunc()); // throws an error
